...
% domain (reported in Figure 3A). Loaded data are 500-sweep averaged
...
% (2,801); real and imaginary coefficients for positive frequencies up to 
% 1,000 are input to the classifier. Classification is performed across 
% participants using 10-fold cross validation, LDA, and dimensionality 
% reduction using PCA (components retained explain 99% of the variance). 
% The first part of the script runs the classification and saves out a 
% .mat file. The second part of the script conducts the permutation test 
% (1,000 classifications with labels shuffled independently of data 
