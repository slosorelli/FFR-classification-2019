% losorelli_8_computeVisualizeRDM.m
% --------------------
% 
...
figDir = '/Users/slosorelli/Desktop/FFRmanuscript/figures';
...
cd(figDir)
set(gcf, 'PaperPosition', [0 0 23 8.5]);
saveas(gcf, ['losorelli-figure-3a-timeDomainTrials'])
...
figDir = '/Users/stevenlosorelli/Desktop/ACLS1_2/ABRdata/Figs';
cd(figDir)

set(gcf, 'PaperPosition', [0 0 14 8]);
saveas(gcf, ['TemporalSearchlight_40msWindows_Overlapping_13subs_20180823.png'])
