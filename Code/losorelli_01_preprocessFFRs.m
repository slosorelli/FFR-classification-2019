...
% losorelli_1_preprocessFFRs.m
% --------------------
% 
% This script loads IHS .txt files from each participant and stimulus. It
% then aggregates these into a single .mat file. Aggregated .mat files are
% saved (all time). Next, files are epoched to the 5-145msec time window,
% the data is centered (dcCorrect), and saved.
...
%load the IHS .TXT exports
inDir = '/Users/slosorelli/Desktop/FFRmanuscript/IHSdata/aggr_100_txt/' 
outDir = '/Users/slosorelli/Desktop/FFRmanuscript/IHSdata/aggr_100_mat'
timeDir = '/Users/slosorelli/Desktop/FFRmanuscript/IHSdata/'
...
%% Aggregate data in .mat format each participant

inDir = '/Users/slosorelli/Desktop/FFRmanuscript/IHSdata/aggr_100_mat/' 
...
dataDir = '/Users/slosorelli/Desktop/FFRmanuscript/data'
cd(dataDir)
