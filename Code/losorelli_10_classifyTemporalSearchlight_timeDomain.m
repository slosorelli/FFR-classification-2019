...
% windows). For this classification, time-domain data are input to the 
% classifier (Figure 4). The first part of the script performs the main 
% classification. The second part of the script performs permutation 
